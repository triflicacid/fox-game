...
export abstract class ChromeTheme {
    ...
    /** Draws a themed line from `(x1, y1)` to `(x2, y2)`, `thickness` canvas pixels wide - a flat stroke, or (for horizontal/vertical lines) a bevelled groove, per theme. Currently used for an {@link HrInput}, but designed for any future straight-line chrome. */
