...
export const POPUP_CONFIG = {
    ...
    /** Text colour for the popup's lines of text and buttons. */
    textColor: "#ffffff",
    /** Font for the popup's lines of text and buttons. */
    font: "14px monospace",
    /** Vertical spacing between lines of text (and the button row), in canvas pixels. */
    lineHeight: 20,
